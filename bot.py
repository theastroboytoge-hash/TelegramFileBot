...
# بقیه هندلرها (myfiles, delete, rename, add_alias, admin_all) بدون تغییر هستند
# (برای کوتاه شدن پاسخ، همان کد قبلی را نگه داشتم)
...
# ... (بقیه توابع delete_file, rename_file, add_alias, admin_all را از کد قبلی کپی کنید)
# ====================== ساخت اپلیکیشن ======================
